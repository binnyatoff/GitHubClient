...
import ru.binnyatoff.githubclient.screens.MainActivity
...
class Users : Fragment(R.layout.fragment_users) {
    ...
    fun recyclerView(recyclerView: RecyclerView, adapter: UsersAdapter) {
    ...
    fun observers(progressCircular: ProgressBar, adapter: UsersAdapter) {
